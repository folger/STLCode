...
objects = utils.o STL.o Pairs.o Tuples.o shared_ptr.o algorithms.o iterators.o array.o vector.o list.o set.o map.o unordered_container.o

STL:$(objects)
		$(cc) -o STL $(objects)

utils.o : utils.h
STL.o : Pairs.h Tuples.h shared_ptr.h algorithms.h iterators.h array.h vector.h list.h set.h map.h unordered_container.h
